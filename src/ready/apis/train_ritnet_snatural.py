...
from ready.models.ritnet import DenseNet2D
...
def main(args):
    """
    Train pipeline for RITnet (DenseNet2D) with RIT-eyes (s-natural) dataset
    """
    ...
    model = DenseNet2D(in_channels=3, out_channels=4)
